        ...
        <div className="mx-auto mb-10 flex max-w-[1400px] flex-col items-center px-4 text-center sm:px-6">
          <div className="flex w-full justify-center">
            <Image
              ...
              priority
              unoptimized
              className="h-auto w-full max-w-[min(92vw,560px)] object-contain dark:hidden"
            />
            <Image
              src="/brand/logo-hero-eyes-dark.png"
              alt="TOOL 2 DAY"
              width={700}
              height={154}
              priority
              unoptimized
              className="hidden h-auto w-full max-w-[min(92vw,560px)] object-contain dark:block"
            />
          </div>
